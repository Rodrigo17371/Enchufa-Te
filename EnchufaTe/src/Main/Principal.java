...
public class Principal {
    ...
    public static ADM_ActualizarCubiculo actcubi;
     public static void main(String[] args) throws UnsupportedLookAndFeelException{
        ...
        rem.BorrarBordesEmpleados();
        raem.BorrarBordesEmpleados();
        rl.BorrarBordesLocales();
        acloc.BorrarBordesLocales();
        rep.BorrarBordesProducto();
        acprod.BorrarBordesProducto();
        repv.BorrarBordesProveedor();
        acprov.BorrarBordesProveedor();
        rec.BorrarBordesClientes();
        acli.BorrarBordesClientes();
        rgc.BorrarBordesCompra();
        acom.BorrarBordesCompra();
        rgr.BorrarBordesReserva();
        acre.BorrarBordesReserva();
